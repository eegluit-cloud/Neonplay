...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( UserModel user,  WalletModel? wallet)?  authenticated,TResult Function( String? error)?  unauthenticated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Authenticated() when authenticated != null:
return authenticated(_that.user,_that.wallet);case _Unauthenticated() when unauthenticated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( UserModel user,  WalletModel? wallet)  authenticated,required TResult Function( String? error)  unauthenticated,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Authenticated():
return authenticated(_that.user,_that.wallet);case _Unauthenticated():
return unauthenticated(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( UserModel user,  WalletModel? wallet)?  authenticated,TResult? Function( String? error)?  unauthenticated,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Authenticated() when authenticated != null:
...
class _Authenticated implements AuthState {
  const _Authenticated({required this.user, this.wallet});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Authenticated&&(identical(other.user, user) || other.user == user)&&(identical(other.wallet, wallet) || other.wallet == wallet));
}
...
@override
String toString() {
  return 'AuthState.authenticated(user: $user, wallet: $wallet)';
}
...
@useResult
$Res call({
 UserModel user, WalletModel? wallet
});


$UserModelCopyWith<$Res> get user;$WalletModelCopyWith<$Res>? get wallet;
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? user = null,Object? wallet = freezed,}) {
  return _then(_Authenticated(
user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as UserModel,wallet: freezed == wallet ? _self.wallet : wallet // ignore: cast_nullable_to_non_nullable
as WalletModel?,
  ));
}
