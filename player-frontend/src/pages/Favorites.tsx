    ...
    <div className="min-h-screen min-h-[100dvh] bg-background">
      ...
      <div className={`transition-all duration-300 pt-14 md:pt-16 pb-20 md:pb-0 ${sidebarOpen ? 'md:ml-56' : 'md:ml-16'}`}>
        <main className="p-3 md:p-4 lg:p-6 space-y-4 md:space-y-6 overflow-x-hidden page-transition-enter max-w-full">
          ...
          <GameCategoryNav activeTab="favorites" />

          {/* Games Grid */}
          {!isAuthenticated ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground text-lg mb-4">Please sign in to view your favorites</p>
              <button
            ...
            <ApiGameGrid
              ...
              emptyMessage="No favorite games yet. Start adding games to your favorites!"
            />
          )}
