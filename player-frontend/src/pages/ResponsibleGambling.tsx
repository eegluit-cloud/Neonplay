    ...
    sections={[
      {
        ...
        content: (
          <div className="space-y-3">
            <p>At Neon Play, we are committed to promoting responsible gambling and providing a safe, enjoyable experience for all our users. We believe that gambling should always be a form of entertainment, never a way to make money or escape problems.</p>
      ...
      },
      {
        ...
        content: (
          <div className="space-y-3">
            <p>If you feel you need a break from gambling, you can self-exclude from Neon Play for a period of your choosing:</p>
            <ul className="list-disc pl-5 space-y-1">
