              ...
              <div className="relative">
                ...
                <div className="relative bg-[#0a0e14] rounded-xl p-5 md:p-8">
                  ...
                  <div className="text-muted-foreground text-sm space-y-1 mb-4">
                    <p>1. Enter your Neon Play username. It must match your profile.</p>
                    <p>2. Enter the email address associated with your Neon Play account. It must match your profile.</p>
                  </div>
