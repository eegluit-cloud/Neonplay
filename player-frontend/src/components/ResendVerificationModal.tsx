...
import resendDealer from '@/assets/resend-dealer.png';
...
export function ResendVerificationModal({ isOpen, onClose, onResend, email }: ResendVerificationModalProps) {
          ...
          <div className="p-4 relative">
            ...
            <div className="p-4 bg-secondary/50 rounded-xl mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-foreground font-medium mb-1">300% Joining Bonus is almost yours</p>
                  <p className="text-xs text-muted-foreground">
                    We have sent a verification email to your email address. Please check both your inbox and spam folders.
                  </p>
                </div>
              </div>
            </div>
            ...
            {email && (
              <div className="p-3 bg-secondary/30 rounded-xl mb-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 min-h-[380px]">
            ...
            <div className="relative flex items-center justify-center p-6 order-1">
              <img
                src={resendDealer}
                alt="Casino Dealer"
                className="w-full max-w-[300px] h-auto object-contain select-none pointer-events-none"
                loading="eager"
              />
            </div>
              ...
              <div className="relative w-full">
                ...
                <div className="relative bg-gradient-to-br from-[#1a1f26] to-[#12161c] rounded-xl p-6 text-center">
                  ...
                  <p className="text-white font-semibold mb-4">
                    300% Joining Bonus is almost yours.
                  </p>
